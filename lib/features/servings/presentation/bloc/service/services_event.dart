...
class GetServingTypesEvent extends ServicesEvent {}
...
class RateServiceEvent extends ServicesEvent {
  final int serviceId;
  final double rating;

  const RateServiceEvent({required this.serviceId, required this.rating});
