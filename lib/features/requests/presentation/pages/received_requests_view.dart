...
class _ReceivedRequestsViewState extends State<ReceivedRequestsView> {
  ...
  void _showCompletionDialog(int requestId) {
    DialogUtils.showConfirmDialog(
      context: context,
      title: "إكمال الخدمة",
      message: "هل أنت متأكد أنك قمت بإكمال هذه الخدمة بنجاح؟ سيتم إخطار المستفيد لتأكيد الإنجاز.",
      confirmText: "نعم، أكملت",
      onConfirm: () {
        context.read<RequestsBloc>().add(RequestCompletionEvent(requestId));
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocListener(
      listeners: [
        BlocListener<ReceivedRequestsBloc, ReceivedRequestsState>(
      ...
      child: BlocBuilder<ReceivedRequestsBloc, ReceivedRequestsState>(
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ReceivedRequestCard(
                    ...
                    onComplete: () => _showCompletionDialog(reqItem.id),
                  );
                },
              ),
              if (isProcessing)
