// lib/features/my_servings/presentation/views/edit_serving_sheet.dart
...
class _EditServingSheetState extends State<EditServingSheet> {
  ...
  void initState() {
    ...
    _priceController = TextEditingController(text: widget.serving.costAmount.toInt().toString());
    _selectedMeetingType = widget.serving.meetingType;
  }
