...
class ChatRepositoryImpl implements ChatRepository {
  ...
  @override
  Future<Either<Failure, Unit>> sendTypingIndicator(int chatId) async {
    try {
  ...
  @override
  Future<Either<Failure, Unit>> stopTypingIndicator(int chatId) async {
    try {
  ...
  @override
  Future<Either<Failure, List<ChatEntity>>> searchChats(String query) async {
    try {
