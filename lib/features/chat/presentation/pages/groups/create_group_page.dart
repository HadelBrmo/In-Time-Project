...
class _CreateGroupPageState extends State<CreateGroupPage> {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ResponsiveLayout(
          mobileBody: _buildContent(isDarkMode, theme, inputFillColor),
          tabletBody: Center(
            child: ConstrainedBox(
              constraints: const BoxConstraints(maxWidth: 600),
              child: _buildContent(isDarkMode, theme, inputFillColor),
            ),
          ),
          desktopBody: Center(
            child: ConstrainedBox(
  ...
  Widget _buildContent(bool isDarkMode, ThemeData theme, Color inputFillColor) {
