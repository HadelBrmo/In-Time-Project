...
abstract class AuthRemoteDataSource {
  ...
  Future<LoginAuthModel> refreshToken({required String refreshToken});
...
@override
Future<LoginAuthModel> refreshToken({required String refreshToken}) async {
try {
final response = await dio.post(
"/auth/refresh",
data: {
...
throw ServerExceptionWithDetails(
message: 'حدث خطأ غير متوقع أثناء تجديد التوكن',
);
}
}
